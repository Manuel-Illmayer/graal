 ...
 * <li>Teardown hooks (always executed on isolate teardown, except for abrupt termination)</li>
 * </ol>
 */
...
public final class RuntimeSupport implements VMRuntimeSupport {
    ...
    /**
     * Adds a VM-level startup hook that executes after the isolate is fully
     * {@link #initialize initialized}. Note that there are use cases where isolates are never fully
     * initialized.
     */
    @Platforms(Platform.HOSTED_ONLY.class)
    ...
    public void shutdown() {
         ...
         * disabled) to run any Java-level shutdown hooks that were registered via the JDK API.
         */
